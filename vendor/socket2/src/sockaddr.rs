...
impl SockAddr {
    ...
    /// Returns `true` if this address has a length of 0.
...
mod tests {
    ...
    fn test_eq(a0: SockAddr, a1: SockAddr, b: SockAddr) {
        assert_eq!(a0.clone(), a0);
        assert_eq!(a0.clone(), a1.clone());
        assert_eq!(a1.clone(), a0.clone());
        assert_ne!(a0.clone(), b.clone());
        assert_ne!(b, a0);
    }

    fn test_hash(a0: SockAddr, a1: SockAddr, b: SockAddr) {
        assert_eq!(calculate_hash(&a0), calculate_hash(&a0.clone()));
